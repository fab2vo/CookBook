 ...
 * input : all fields of recipe but photo and date et message= optionmessage pour nouvelle recette
 ...
 function debugtrace($sin)
{
 ...
 if ($debug==1) {
 file_put_contents("debug.txt","Debut uploadorcreaterecipe \r\n ");  
 }
...
if ($row_count==0) {
	...
	if ($row_member_count==0) { debugtrace("F "); echo $notfound; exit;} 
	...
	/* --- insert for each member */
		...
		if (!$result2) { debugtrace("F "); echo $notfound; exit;}
	}
 }
